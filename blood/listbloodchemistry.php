...
// list query for sql
$sql_list = "SELECT bc.bsid, p.initials, p.firstname, p.surname, bc.create_date
FROM bloodchemistry bc inner join patient p where  p.pid = bc.pid order by create_date desc";
