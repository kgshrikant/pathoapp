...
if($_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  // get id details from report table
   ...
   ["class_id"],
   ["class_type" => "bloodchemistry", "rid" => "{$rid}" ]);
  ...
  "bloodurea", "serumcreatine", "serumcholestrol","hdl","serumuricacid","serumtry","create_date"],
  ["id" => $id ]);
...
<!-- Patient Details -->
  <div class="container">
    ...
    <div class="row m-5">
      <div class="col-sm-12 text-center mx-auto ">
        <h4 class="display-6 report_header" style=""><b>REPORT ON BLOOD CHEMISTRY</b></h4>
      </div>
      <br>
    </div>
    <!-- Columns -->
    ...
    <div class="row mx-auto" style="position:relative; top: 220px;">
